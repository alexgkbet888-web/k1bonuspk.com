...
Static SEO site for k1bonuspk.com.

## Deployment

1. Create a GitHub repository named `k1bonuspk.com` under `alexgkbet888-web`.
2. Push this folder to the repository `main` branch.
3. Enable GitHub Pages from `main` / root.
4. Keep the root `CNAME` file as `k1bonuspk.com`.
...
- Submit `https://k1bonuspk.com/sitemap.xml` in Google Search Console.
